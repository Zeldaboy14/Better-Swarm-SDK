...
"sdkevents"
{
	...
	"point_captured"
	{
		"team"		"short"  //team that made a capture
		"location"	"string"  //location of capture point
		"slot"		"short"
	}
	"team_timer"
	{
		"redtime"		"float" //the time the red team has left
		"bluetime"		"float" //the time the blue team has left
	}
	"render_playerwait"
	{
		"render"		"bool"  //Should I render this HUD element?
		"time"			"short" //Time left for playerwait
	}
	"start_round"
	{
		"time"			"float" //The time the round started.
		"tip"			"string" //Token corresponding to the correct tip to show
	}
	"update_roundscore"
	{
		"axis_score"	"short"
		...
		"player_4"			"short"
		"player_4_points"  	"short"
		"player_5"			"short"
		"player_5_points"  	"short"
		"player_6"			"short"
		"player_6_points"  	"short"
	}
	"point_status1"
	{
		"capturer"		"short"
